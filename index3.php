...
<head>
  ...
  <title>Redho Tours & Travel Official</title>
...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5990">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url(assets/img/slide/mekkah-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang di website <span>Redho Tours & Travel</span></h2>
                <p class="animate__animated animate__fadeInUp">Kami adalah kelompok profesional yang berdedikasi sepenuhnya untuk memandu dan menyediakan pengalaman perjalanan Haji dan Umroh yang luar biasa. Dengan fokus pada pelayanan terbaik, kami berkomitmen untuk memberikan layanan yang mengutamakan kenyamanan, keamanan, dan ketenangan hati bagi para peziarah yang melibatkan diri dalam perjalanan suci ini.</p>
                <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Kenal kami lebih dekat!</a>
              </div>
            </div>
          </div>

          <!-- Slide 2 -->
          <div class="carousel-item" style="background-image: url(assets/img/slide/mekkah-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang di website <span>Redho Tours & Travel</span></h2>
                <p class="animate__animated animate__fadeInUp">Kami adalah kelompok profesional yang berdedikasi sepenuhnya untuk memandu dan menyediakan pengalaman perjalanan Haji dan Umroh yang luar biasa. Dengan fokus pada pelayanan terbaik, kami berkomitmen untuk memberikan layanan yang mengutamakan kenyamanan, keamanan, dan ketenangan hati bagi para peziarah yang melibatkan diri dalam perjalanan suci ini.</p>
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background-image: url(assets/img/slide/mekkah-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang di website <span>Redho Tours & Travel</span></h2>
                <p class="animate__animated animate__fadeInUp">Kami adalah kelompok profesional yang berdedikasi sepenuhnya untuk memandu dan menyediakan pengalaman perjalanan Haji dan Umroh yang luar biasa. Dengan fokus pada pelayanan terbaik, kami berkomitmen untuk memberikan layanan yang mengutamakan kenyamanan, keamanan, dan ketenangan hati bagi para peziarah yang melibatkan diri dalam perjalanan suci ini.</p>
  ...
  <main id="main">
    ...
    <section id="about" class="about section-bg">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/about1.jpg" class="rounded img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <h3>Kami menyediakan berbagai layanan terbaik untuk jamaah. </h3>
            <p>
              Dengan memilih Redho Tour & Travel, Anda memastikan bahwa perjalanan spiritual Anda akan menjadi pengalaman yang penuh berkah dan bimbingan. Tim kami terdiri dari muttawif yang berkompeten dan berpengalaman, yang akan memberikan panduan dan dukungan penuh selama perjalanan Anda. Kami memahami betapa pentingnya setiap langkah dalam ibadah, dan kami berkomitmen untuk memberikan layanan dan fasilitas terbaik guna memastikan kenyamanan dan ketenangan hati Anda selama perjalanan.
            </p>
            <p>
              Bersama Redho Tour & Travel, Anda tidak hanya mendapatkan sebuah perusahaan travel, tetapi juga teman sejati dalam perjalanan spiritual Anda. Kami menempatkan nilai-nilai kepercayaan, dedikasi, dan keprofesionalan sebagai landasan utama setiap layanan yang kami tawarkan. Jelajahi paket-paket perjalanan eksklusif kami dan mari bersama-sama mengukir kenangan berharga dalam perjalanan rohani Anda.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Galeri Perjalanan Jamaah Umroh dan Haji</li>
            </ul>
          </div>
        </div>
    ...
    <section class="cta2">
      <div class="container">
        ...
        <div class="text-center">
          <h3 class="top">REDHO TOURS & TRAVEL </h3>
          <h1><span class="left">50%</span> website under construction</h1>
          <a class="cta2-btn" href="#">Wait</a>
        </div>
...
<!-- AKHIR TESTIMONIAL -->
          ...
          <div class="col-lg-6 d-flex align-items-stretch infos">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 info d-flex flex-column align-items-stretch">
                <i class="bx bx-map"></i>
                <h4>Address</h4>
                <p>Jl. M.H. Thamrin No.1,<br>Jakarta Utara, Indonesia 10310</p>
              </div>
              <div class="col-lg-6 info info-bg d-flex flex-column align-items-stretch">
                <i class="bx bx-phone"></i>
                <h4>Call Us</h4>
                <p>(62) 811 528 286<br>(62) 822 2154 7686</p>
              </div>
              <div class="col-lg-6 info info-bg d-flex flex-column align-items-stretch">
                <i class="bx bx-envelope"></i>
                <h4>Email Us</h4>
                <p>contact@redhotours.com<br>info@redhotours.com</p>
              </div>
              <div class="col-lg-6 info d-flex flex-column align-items-stretch">
                <i class="bx bx-time-five"></i>
                <h4>Working Hours</h4>
                <p>Senin - Sabtu: 09:00 - 16:00<br>Minggu: 09:00 - 12:00</p>
              </div>
            </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>
              ...
              Jakarta Utara, Indonesia 10310<br><br>
              <strong>Phone:</strong> (021) 2356 7890<br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2023 Copyright <strong><span>REDHO TOURS & TRAVEL</span></strong>. All Rights Reserved
      </div>
  </footer><!-- End Footer -->
