!(function (t, i) {
  ...
  function b(t, i, e) {
    if (!e || w !== x) return w.call(window, C(t, i));
    t.call(i);
  }
  function T(t) {
    t && P.call(window, t);
  ...
  function gi(t, i) {
    (t._leaflet_pos = i),
      vt ? fi(t, i) : ((t.style.left = i.x + "px"), (t.style.top = i.y + "px"));
  }
  function vi(t) {
  ...
  function wi(t) {
    ...
    t.style &&
      ...
      Mi(window, "keydown", Pi));
  }
  function Pi() {
    Kt &&
      ((Kt.style.outline = Yt), (Yt = Kt = void 0), Ci(window, "keydown", Pi));
  }
  function Li(t) {
    for (
      ;
  ...
  function Mi(t, i, e, n) {
    ...
    else for (var s = 0, r = (i = l(i)).length; s < r; s++) Ei(t, i[s], e, n);
    return this;
  }
  ...
  function Ci(t, i, e, n) {
    if ("object" == typeof i) for (var o in i) ki(t, o, i[o], e);
      ...
      for (var a in t[zi]) ki(t, a, t[zi][a]);
      delete t[zi];
    }
    return this;
  }
  ...
  function Ei(i, t, e, n) {
    ...
    Lt && 0 === t.indexOf("touch")
      ? ((c = i),
        ...
        "touchstart" === (_ = t)
          ? ((v = c),
            ...
            (v["_leaflet_touchstart" + x] = w),
            v.addEventListener(At, w, !1),
            Dt ||
              (document.addEventListener(At, jt, !0),
              document.addEventListener(It, Wt, !0),
              document.addEventListener(Ot, Ht, !0),
              document.addEventListener(Rt, Ht, !0),
              (Dt = !0)))
          : "touchmove" === _
          ? ((g = d),
            (c["_leaflet_touchmove" + p] = z),
            c.addEventListener(It, z, !1))
          : "touchend" === _ &&
            ((f = d),
            ((m = c)["_leaflet_touchend" + p] = M),
            m.addEventListener(Ot, M, !1),
            m.addEventListener(Rt, M, !1)))
      : bt && "dblclick" === t && !Si()
      ? ((r = P),
        (l = !1),
        ((s = i)[$t + Xt + (a = o)] = b),
        (s[$t + Jt + a] = T),
        (s[$t + "dblclick" + a] = r),
        s.addEventListener(Xt, b, !!Ct && { passive: !1 }),
        s.addEventListener(Jt, T, !!Ct && { passive: !1 }),
      ...
      ? "touchstart" === t ||
        ...
        "wheel" === t ||
        "mousewheel" === t
        ? i.addEventListener(Zi[t] || t, P, !!Ct && { passive: !1 })
        : "mouseenter" === t || "mouseleave" === t
        ? ((P = function (t) {
            (t = t || window.event), Ui(i, t) && L(t);
          }),
          i.addEventListener(Zi[t], P, !1))
        : i.addEventListener(t, L, !1)
      : "attachEvent" in i && i.attachEvent("on" + t, P),
      (i[zi] = i[zi] || {}),
      (i[zi][o] = P);
  }
  function ki(t, i, e, n) {
    ...
    Lt && 0 === i.indexOf("touch")
      ? ((l = (h = t)["_leaflet_" + (u = i) + c]),
        "touchstart" === u
          ? h.removeEventListener(At, l, !1)
          : "touchmove" === u
          ? h.removeEventListener(It, l, !1)
          : "touchend" === u &&
            (h.removeEventListener(Ot, l, !1),
            h.removeEventListener(Rt, l, !1)))
      : bt && "dblclick" === i && !Si()
      ? ((s = (o = t)[$t + Xt + c]),
        (r = o[$t + Jt + c]),
        (a = o[$t + "dblclick" + c]),
        o.removeEventListener(Xt, s, !!Ct && { passive: !1 }),
        o.removeEventListener(Jt, r, !!Ct && { passive: !1 }),
        o.removeEventListener("dblclick", a, !1))
      : "removeEventListener" in t
      ? t.removeEventListener(Zi[i] || i, _, !1)
      : "detachEvent" in t && t.detachEvent("on" + i, _),
      (t[zi][c] = null);
  }
  function Bi(t) {
    return (
  ...
  var Vi = {
    ...
    Gi = E.extend({
      ...
      flyTo: function (r, a, t) {
        if (!1 === (t = t || {}).animate || !vt) return this.setView(r, a, t);
        this._stop();
        ...
        var v = Date.now(),
          y = (e(1) - g) / d,
          x = t.duration ? 1e3 * t.duration : 1e3 * y * 0.8;
        return (
      ...
      _onDown: function (t) {
        ...
        !t._simulated &&
          ...
          ui(this._element, "leaflet-zoom-anim") ||
            ...
            ((re._dragging = this)._preventOutline && wi(this._element),
            yi(),
            qt(),
            this._moving ||
              (this.fire("down"),
  ...
  function ae(t, i) {
    ...
    return (function (t, i) {
      ...
      for (var o = [], s = 0; s < e; s++) n[s] && o.push(t[s]);
      return o;
    })(
      (t = (function (t, i) {
    ...
    for (s = 0; s < 4; s++) {
      for (h = l[s], n = [], c = 0, o = (_ = t.length) - 1; c < _; o = c++)
        (r = t[c]),
          ...
          r._code & h
            ? a._code & h ||
              (((u = le(a, r, h, i, e))._code = ce(u, i)), n.push(u))
            : (a._code & h &&
                (((u = le(a, r, h, i, e))._code = ce(u, i)), n.push(u)),
              n.push(r));
      t = n;
  ...
  var Me = Te.extend({
    ...
    Ie = ke.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var i, e, n = 1 / 0, o = null, s = _e, r = 0, a = this._parts.length;
          r < a;
          r++
        )
  ...
  var qe = {
    toGeoJSON: function (t) {
      return Ue(this, { type: "Point", coordinates: He(this.getLatLng(), t) });
    },
  };
  function Ge(t, i) {
    return new Re(t, i);
    ...
    Ye = Te.extend({
      ...
      _initImage: function () {
        ...
        li(i, "leaflet-image-layer"),
          ...
          (i.onselectstart = a),
          (i.onmousemove = a),
          (i.onload = C(this.fire, this, "load")),
          (i.onerror = C(this._overlayOnError, this, "error")),
    ...
    Xe = Ye.extend({
      ...
      _initImage: function () {
        ...
        if (
          ...
          (i.onselectstart = a),
          (i.onmousemove = a),
          (i.onloadeddata = C(this.fire, this, "load")),
          t)
        ) {
          for (
  ...
  var nn = Te.extend({
      ...
      _addTile: function (t, i) {
        ...
        this._initTile(o),
          this.createTile.length < 2 && b(C(this._tileReady, this, t, null, o)),
          gi(o, e),
    ...
    on = nn.extend({
      ...
      createTile: function (t, i) {
        ...
        return (
          Mi(e, "load", C(this._tileOnLoad, this, i, e)),
          Mi(e, "error", C(this._tileOnError, this, i, e)),
          (!this.options.crossOrigin && "" !== this.options.crossOrigin) ||
            (e.crossOrigin =
              !0 === this.options.crossOrigin ? "" : this.options.crossOrigin),
          (e.alt = ""),
      ...
      _abortLoading: function () {
        ...
        for (t in this._tiles)
          this._tiles[t].coords.z !== this._tileZoom &&
            ...
            (i.onerror = a),
            i.complete || ((i.src = g), si(i), delete this._tiles[t]));
      },
      _removeTile: function (t) {
        var i = this._tiles[t];
        if (i)
          return (
            at || i.el.setAttribute("src", g),
  ...
  var rn = on.extend({
    ...
    getTileUrl: function (t) {
      var i = this._tileCoordsToNwSe(t),
        ...
        o = n.min,
        s = n.max,
        r = (1.3 <= this._wmsVersion && this._crs === Le
          ? [o.y, o.x, s.y, s.x]
          : [o.x, o.y, s.x, s.y]
        ).join(","),
  ...
  (dn.create = _n),
    ...
    (Re.coordsToLatLngs = We),
    (Re.latLngToCoords = He),
    ...
    _onDown: function (t) {
      if (t.touches) {
        ...
        (this._startPos = this._newPos = new k(i.clientX, i.clientY)),
          ...
          Mi(document, { touchmove: this._onMove, touchend: this._onUp }, this);
      }
    },
    _onUp: function (t) {
      var i, e;
  ...
  !bt || (Lt && !ct) || Gi.addInitHook("addHandler", "tap", wn),
  ...
  Gi.addInitHook("addHandler", "touchZoom", Pn),
    (Gi.BoxZoom = fn),
